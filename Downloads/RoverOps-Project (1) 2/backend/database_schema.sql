...
-- This file creates all necessary tables for storing mission data
...
CREATE TABLE IF NOT EXISTS mission_logs (
    ...
    FOREIGN KEY (mission_id) REFERENCES mission_reports(mission_id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO mission_statistics (total_missions, completed_missions, aborted_missions, error_missions, total_steps_executed, total_duration_seconds, average_duration_seconds)
